function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="mb-8">
      <h2 className="text-base font-bold text-gray-900 mb-2 border-b border-gray-100 pb-1.5">{title}</h2>
...
export default function PrivacidadContent() {
  return (
    <div className="prose-gray">
      <p className="text-xs text-gray-400 mb-6">Última actualización: abril de 2026</p>
      ...
      <Section title="3. Integración con Google Calendar">
        ...
        <p>Cuando conectás tu Google Calendar, KLIA solicita acceso a los siguientes scopes:</p>
        <ul>
          <li>
        ...
        <ul>
          <li><strong>Solo leemos</strong> el título, horario de inicio y fin de tus eventos existentes para mostrarlos como bloques en tu agenda</li>
          <li><strong>Solo creamos</strong> eventos con el nombre del paciente, fecha y duración de cada sesión registrada en KLIA</li>
      ...
      <Section title="5. Almacenamiento y seguridad">
        ...
        <ul>
          ...
          <li>Control de acceso mediante Row Level Security (RLS) — cada profesional solo accede a sus propios datos</li>
      ...
      <Section title="8. Derechos del usuario">
        <p>En cumplimiento de la Ley 25.326, los usuarios tienen derecho a:</p>
        <ul>
      ...
      <Section title="11. Contacto">
        <p>Para consultas sobre esta política o el tratamiento de tus datos:</p>
        <ul>
