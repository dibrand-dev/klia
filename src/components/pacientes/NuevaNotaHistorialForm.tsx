...
export default function NuevaNotaHistorialForm({ pacienteId }: { pacienteId: string }) {
  ...
  async function handleGuardar() {
    ...
    if (!terapeutaId) {
      console.error('[NuevaNotaHistorialForm] terapeutaId no resuelto todavía')
      return
    }
    setLoading(true)
    setError(null)
    ...
    router.push(`/pacientes/${pacienteId}/historial`)
    router.refresh()
  }
