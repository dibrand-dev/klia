  ...
  public: {
    Tables: {
      ...
      colaboradores: {
        ...
        Relationships: [
          {
            foreignKeyName: 'colaboradores_profesional_id_fkey'
      ...
      planes_alimentarios: {
        ...
        Relationships: [
          {
            foreignKeyName: 'planes_alimentarios_paciente_id_fkey'
            columns: ['paciente_id']
            isOneToOne: false
            referencedRelation: 'pacientes'
            referencedColumns: ['id']
      ...
      plan_comida_items: {
        ...
        Relationships: [
          {
            foreignKeyName: 'plan_comida_items_comida_id_fkey'
            columns: ['comida_id']
            isOneToOne: false
            referencedRelation: 'plan_comidas'
            referencedColumns: ['id']
          },
        ]
      }
      ...
      vademecum_alimento_nutrientes: {
        ...
        Relationships: [
          {
            foreignKeyName: 'vademecum_alimento_nutrientes_alimento_id_fkey'
            columns: ['alimento_id']
            isOneToOne: false
